			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12">
								<a href="idfind.do" class="active" id="login-form-link">Forgot Password?</a>
							</div>
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form method="POST" id="pwfind2" role="form" style="display: block;">
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
												<input type="button" onclick="javascript:pwfind2()" tabindex="4" class="form-control btn btn-login" value="Password 찾기 "> 
											</div>
										</div>
									</div>
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
												<a href="login.do"><input type="button" tabindex="4" class="form-control btn btn-login" value="로그인"></a>
											</div>
										</div>
									</div>
...
<script src="//code.jquery.com/jquery-1.11.1.min.js"></script>
	...
	function pwfind2(){
			...
			if(id.val() == "") {
				...
				findPassword.attr("action", "pwfind2.do");
				findPassword.submit();
				return true;
			}
