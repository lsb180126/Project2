...
public class ParkingDTO {
	...
	public void setParkingIincnt(String parkingIincnt) {
		this.parkingIincnt = parkingIincnt;
	}
	public String getParkingIoutcnt() {
		return parkingIoutcnt;
	}
	public void setParkingIoutcnt(String parkingIoutcnt) {
		this.parkingIoutcnt = parkingIoutcnt;
	}
	public String getParkingIstay() {
		return parkingIstay;
	}
	public void setParkingIstay(String parkingIstay) {
		this.parkingIstay = parkingIstay;
	}
