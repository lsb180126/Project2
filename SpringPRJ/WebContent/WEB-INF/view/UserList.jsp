...
<!--================About Area End =================-->
    ...
    <section class="blog-area blog-page section-padding-100">
		...
		<div class="row1" style="border-top: 1px solid #e3e6f0;  border-left: 1px solid #e3e6f0;">
			<div class="col-md-3" style="border-right: 1px solid #e3e6f0; border-bottom: 1px solid #e3e6f0;">아이디</div>
			<div class="col-md-2" style="border-right: 1px solid #e3e6f0; border-bottom: 1px solid #e3e6f0;">이름</div>
			<div class="col-md-3" style="border-right: 1px solid #e3e6f0; border-bottom: 1px solid #e3e6f0;">이메일</div>
			<div class="col-md-1" style="border-right: 1px solid #e3e6f0; border-bottom: 1px solid #e3e6f0;">성별</div>	
			<div class="col-md-3" style="border-right: 1px solid #e3e6f0; border-bottom: 1px solid #e3e6f0;">핸드폰번호</div>
		</div>
		</div>
		...
		<div class="row1" style="border-left: 1px solid #e3e6f0;border-top: 2px solid #e3e6f0;">	
			<div class="col-md-3" style="border-right: 1px solid #e3e6f0; border-bottom: 1px solid #e3e6f0;"><%=ulist.get(i).getUserId()%></div>
			<div class="col-md-2" style="border-right: 1px solid #e3e6f0; border-bottom: 1px solid #e3e6f0;"><a href="/UserDetail.do?userNo=<%=ulist.get(i).getUserNo() %>"><%=ulist.get(i).getUserName()%></a></div>
			<div class="col-md-3" style="border-right: 1px solid #e3e6f0; border-bottom: 1px solid #e3e6f0;"><%=ulist.get(i).getEmail()%></div>
			<div class="col-md-1" style="border-right: 1px solid #e3e6f0; border-bottom: 1px solid #e3e6f0;"><%=ulist.get(i).getGender()%></div>	
			<div class="col-md-3" style="border-right: 1px solid #e3e6f0; border-bottom: 1px solid #e3e6f0;"><%=ulist.get(i).getPhone()%></div>
		</div>
		</div>
		</div>
		<% } %>
	...
	<ul class="pagination">
	  ...
	  <li><a aria-label="Previous" href="${pageContext.request.contextPath}/UserList.do?page=${pDTO.jumpPrevPage}&keyword=${pDTO.keyword}"><span aria-hidden="true">&laquo;</span></a></li>
	
	  <c:forEach begin="${pDTO.pageBegin}" end="${pDTO.pageEnd}" var="idx">
	
	   <c:if test="${pDTO.currentPage == idx}"><li><a href="${pageContext.request.contextPath}/UserList.do?page=${idx}&keyword=${pDTO.keyword}">${idx}</a></li></c:if> 
	
	   <c:if test="${pDTO.currentPage != idx}"><li><a href="${pageContext.request.contextPath}/UserList.do?page=${idx}&keyword=${pDTO.keyword}">${idx}</a></li></c:if>
	
	  </c:forEach>
	
	  <li><a aria-label="Next" href="${pageContext.request.contextPath}/UserList.do?page=${pDTO.jumpNextPage}&keyword=${pDTO.keyword}"><span aria-hidden="true">&raquo;</span></a></li>
