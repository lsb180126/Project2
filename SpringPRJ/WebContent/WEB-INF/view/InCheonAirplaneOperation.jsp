	...
	$(function() {
		$('#arrivesearch').click(
				function() {
					...
					console.log(Arrive);
					var url = "AjaxInCheonAirplaneOperation.do" /*URL*/
							+ "?Arrive=" + Arrive;
					console.log(url);
					...
					$.ajax({
						...
						console.log(data);
							...
							show +='<div class="col-md-2" style="border-right: 1px solid #e3e6f0; border-bottom: 1px solid #e3e6f0;">'+"항공사"+'</div>'
							show +='<div class="col-md-2" style="border-right: 1px solid #e3e6f0; border-bottom: 1px solid #e3e6f0;">'+"항공편명"+'</div>'
							show +='<div class="col-md-2" style="border-right: 1px solid #e3e6f0; border-bottom: 1px solid #e3e6f0;">'+"예정시간"+'</div>'
							show +='<div class="col-md-2" style="border-right: 1px solid #e3e6f0; border-bottom: 1px solid #e3e6f0;">'+"변경시간"+'</div>'
							show +='<div class="col-md-2" style="border-right: 1px solid #e3e6f0; border-bottom: 1px solid #e3e6f0;">'+"출발공항"+'</div>'
							show +='<div class="col-md-2" style="border-right: 1px solid #e3e6f0; border-bottom: 1px solid #e3e6f0;">'+"터미널구분"+'</div>'
							show +='</div>'
							show +='</div>'
							...
							$.each(data, function(key, value) {
								...
								show +='<div class="col-md-2" style="border-right: 1px solid #e3e6f0; border-bottom: 1px solid #e3e6f0;">'+ value.airline +'</div>'
								show +='<div class="col-md-2" style="border-right: 1px solid #e3e6f0; border-bottom: 1px solid #e3e6f0;">'+ value.flightId +'</div>'
								show +='<div class="col-md-2" style="border-right: 1px solid #e3e6f0; border-bottom: 1px solid #e3e6f0;">'+ value.scheduleDateTime +'</div>'
								show +='<div class="col-md-2" style="border-right: 1px solid #e3e6f0; border-bottom: 1px solid #e3e6f0;">'+ value.estimatedDateTime +'</div>'
								show +='<div class="col-md-2" style="border-right: 1px solid #e3e6f0; border-bottom: 1px solid #e3e6f0;">'+ value.airport +'</div>'
								show +='<div class="col-md-2" style="border-right: 1px solid #e3e6f0; border-bottom: 1px solid #e3e6f0;">'+ value.terminalid +'</div>'
								show +='</div>'
								show +='</div>'
								show +='</div>'
								show +='</div>'
	...
	$(function() {
		$('#search2').click(
				function() {
					...
					console.log(Depart);
					var url = "AjaxInCheonDepartAirplaneOperation.do" /*URL*/
							+ "?Depart=" + Depart;
					console.log(url);
					...
					$.ajax({
						...
						console.log(data);
							...
							show +='<div class="col-md-2" style="border-right: 1px solid #e3e6f0; border-bottom: 1px solid #e3e6f0;">'+"예정시간"+'</div>'
							show +='<div class="col-md-2" style="border-right: 1px solid #e3e6f0; border-bottom: 1px solid #e3e6f0;">'+"변경시간"+'</div>'
							show +='<div class="col-md-2" style="border-right: 1px solid #e3e6f0; border-bottom: 1px solid #e3e6f0;">'+"도착지공항"+'</div>'
							show +='<div class="col-md-2" style="border-right: 1px solid #e3e6f0; border-bottom: 1px solid #e3e6f0;">'+"터미널구분"+'</div>'
							show +='</div>'
							show +='</div>'
			...
			<div class="row">
				<div class="col-12">
					...
					<div
			   		...
			   		&nbsp;&nbsp;&nbsp;&nbsp;
						<select class="form1-control" name="Arrive" id="Arrive" style="width:20%; height:34px;">
							<option value="getPassengerArrivalsDS">도착</option>
						</select>
					&nbsp;&nbsp;
					
					<button type="submit" class="btn btn-primary" name="arrivesearch" id="arrivesearch" style="margin:0;">검색</button>
					
					&nbsp;&nbsp;	
						<select class="form1-control" name="Depart" id="Depart" style="width:20%; height:34px;">
							<option value="getPassengerDeparturesDS">출발</option>
						</select>
					
					&nbsp;
					
						<button type="submit" class="btn btn-primary" name="search2" id="search2" style="margin:0;">검색</button>
