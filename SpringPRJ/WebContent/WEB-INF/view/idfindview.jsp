			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12">
								<a class="active" id="login-form-link"><br/></a>
							</div>
							<div class="col-xs-12">
								<a class="active" id="login-form-link"><br/></a>
							</div>
							<div class="col-xs-12">
								<a class="active" id="login-form-link" style="font-size:20px;"><%=uDTO.getUserName() %> 님의 아이디는 "<%=uDTO.getUserId() %>" 입니다.</a>
							</div>
							<br/><br/><br/><br/>
						</div>
						<hr>
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
												<a href="pwfind.do"><input type="button" tabindex="4" class="form-control btn btn-login" value="Password 찾기"></a>
											</div>
										</div>
									</div>
									<div class="form-group">
