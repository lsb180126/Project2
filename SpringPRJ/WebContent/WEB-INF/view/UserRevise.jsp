        	...
        	<div class="container">
					 ...
					 <div class="col col-md-10">
					  ...
					  <div class="form-group required">
					    ...
					    <input type="password" class="form-control" id="passwordcheck" name="passwordcheck" placeholder="Confirm New Password">
					    <!--<small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>-->
					  </div>
					  <div class="form-group required">
					 ...
					 <div class="form-group required">
					    ...
					    <li class="aaaa"><a href="UserDetail.do?userNo=<%=CmmUtil.nvl(uDTO.getUserNo())%>"><button type="button" class="btn btn-primary">이전</button></a></li>
					  </ul>
					</form>
					</div>
