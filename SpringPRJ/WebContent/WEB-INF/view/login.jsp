			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12">
								<a href="login.do" class="active" id="login-form-link">Login</a>
							</div>
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form action="/loginProc.do" method="POST" id="f1" role="form" style="display: block;">
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
												<input type="button" name="ok" id="ok" tabindex="4" class="form-control btn btn-login" value="로그인">
											</div>
										</div>
									</div>
									<div class="form-group">
										<div class="row">
											<div class="col-lg-12">
												<div class="text-center">
													<a href="idfind.do" tabindex="5" class="forgot-password">Forgot Id?</a>
												</div>
												
												<div class="text-center">
													<a href="pwfind.do" tabindex="5" class="forgot-password">Forgot Password?</a>
												</div>
											</div>
										</div>
									</div>
