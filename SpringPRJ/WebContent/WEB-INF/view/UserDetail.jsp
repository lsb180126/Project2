        ...
        <div class="container">
        	...
        	<div class="container">
					 ...
					 <div class="col col-md-10">
					  <form method="POST" action="UserRevise.do?userNo=<%=CmmUtil.nvl(uDTO.getUserNo())%>">
					  ...
					  <div class="form-group required">
					    ...
					    <input type="text" class="form-control" id="exampleInputEmail1" value="<%=CmmUtil.nvl(uDTO.getUserId())%>" readonly>
					    <!--<small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>-->
					  </div>
					  <div class="form-group required">
					    <label for="exampleInputEmail1" class='control-label'>이름</label>
					    <input type="text" class="form-control" id="exampleInputEmail1" value="<%=CmmUtil.nvl(uDTO.getUserName())%>" readonly>
					    <!--<small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>-->
					  </div>
					  <div class="form-group required">
					    <label for="exampleInputEmail1" class='control-label'>성별</label>
					    <input type="text" class="form-control" id="exampleInputEmail1" value="<%=CmmUtil.nvl(uDTO.getGender())%>" readonly>
					    <!--<small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>-->
					  </div>
					  <div class="form-group required">
					    <label for="exampleInputPassword1" class='control-label'>이메일</label>
					    <input type="text" class="form-control" value="<%=CmmUtil.nvl(uDTO.getEmail())%>" id="title" name="title" readonly>
					  </div>
					 <div class="form-group required">
					    <label for="exampleInputPassword1" class='control-label'>핸드폰 번호</label>
					    <input type="text" class="form-control" value="<%=CmmUtil.nvl(uDTO.getPhone())%>" id="title" name="title" readonly>
					  </div>
					
					    <ul class="media-date text-uppercase reviews list-inline">
					    <li class="mm"><button type="submit" class="btn btn-primary" id="ok">수정</button></li>
					    <li class="aaaa"><a href="UserDelete.do?userNo=<%=CmmUtil.nvl(uDTO.getUserNo())%>"><button type="button" class="btn btn-primary" >탈퇴</button></a></li>
					  	<li class="mm"><a href="UserList.do"><button type="button" class="btn btn-primary" id="ok">목록</button></a></li>
					  </ul>
					</form>
					</div>
