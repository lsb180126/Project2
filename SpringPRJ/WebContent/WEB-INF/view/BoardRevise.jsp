        ...
        <div class="container">
        	...
        	<div class="container">
					 ...
					 <div class="col col-md-10">
					  <form id="f1" method="POST" action="/BoardRevise2.do">
					  ...
					  <div class="form-group required">
					    ...
					    <input type="text" class="form-control" id="name" name="name" value="<%=CmmUtil.nvl(bDTO.getUserName())%>" readonly>
					    <!--<small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>-->
					  </div>
					  <div class="form-group required">
					    <label for="exampleInputEmail1" class='control-label'>작성일</label>
					    <input type="text" class="form-control" id="chgDt" name="chgDt" value="<%=CmmUtil.nvl(bDTO.getChgDt())%>" readonly>
					    <!--<small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>-->
					  </div>
					  <div class="form-group required">
					    <label for="exampleInputEmail1" class='control-label'>조회수</label>
					    <input type="text" class="form-control" id="viewCnt" name="viewCnt" value="<%=CmmUtil.nvl(bDTO.getViewCnt())%>" readonly>
					    <!--<small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>-->
					  </div>
					  <div class="form-group required">
					    <label for="exampleInputEmail1" class='control-label'>제목</label>
					    <textarea class="form-control" rows="1" id="title" name="title"><%=CmmUtil.nvl(bDTO.getTitle())%></textarea>
					  </div>
					  
					  <div class="form-group required">
					    <label for="exampleTextarea" class='control-label'>내용</label>
					    <textarea class="form-control" rows="7" id="content" name="content"><%=CmmUtil.nvl(bDTO.getContent())%></textarea>
					  </div>
					  
					  
					    <ul class="media-date text-uppercase reviews list-inline">
					    <li class="mm"><button type="submit" class="btn btn-primary" id="ok">수정</button></li>
					    <li class="aaaa"><a href="BoardDetail.do?boardNo=<%=CmmUtil.nvl(bDTO.getBoardNo())%>"><button type="button" class="btn btn-primary">이전</button></a></li>
					  </ul>
					</form>
					</div>
