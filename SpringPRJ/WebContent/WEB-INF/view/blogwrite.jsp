        ...
        <div class="container">
					...
					<div class="container">
					 ...
					 <div class="col col-md-10">
					  <form action="/blogregister.do" method="POST" id="f1">
					  <div class="form-group required">
					    <label for="exampleInputEmail1" class='control-label'>작성자</label>
					    <input type="text" class="form-control" id="exampleInputEmail1" value="<%=name%>" readonly>
					    <!--<small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>-->
					  </div>
					  <div class="form-group required">
					    <label for="exampleInputPassword1" class='control-label'>제목</label>
					    <input type="text" class="form-control" placeholder="제목을 입력해주세요" id="title" name="title" maxlength="100">
					  </div>
					 
					
					  <div class="form-group required">
					    <label for="exampleTextarea" class='control-label'>내용</label>
					    <textarea class="form-control"  rows="7" id="content" name="content" maxlength="200"></textarea>
					  </div>
					  
					  
					    <ul class="media-date text-uppercase reviews list-inline">
					    <li class="mm"><button type="button" class="btn btn-primary" id="m1">등록</button></li>
