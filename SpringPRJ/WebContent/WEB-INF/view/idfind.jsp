			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-12">
								<a href="idfind.do" class="active" id="login-form-link">Forgot Id?</a>
							</div>
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form action="/idfind2.do" method="POST" id="f2" role="form" style="display: block;">
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
												<input type="button" name="find" id="find" tabindex="4" class="form-control btn btn-login" value="Id찾기">
											</div>
										</div>
									</div>
									<div class="form-group">
